...
import com.brain.words.puzzle.crypto.fs.cipher.CipherTextSerializer
...
class AesSecurePreferences(
    ...
    companion object {
        private const val AES_SECURE_SHARED_PREFERENCES_FILE_NAME = "com.brain.words.puzzle.AesSecurePreferences"
    }
}
