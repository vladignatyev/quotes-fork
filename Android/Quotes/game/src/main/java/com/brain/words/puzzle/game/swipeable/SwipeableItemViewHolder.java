...
import com.brain.words.puzzle.game.swipeable.annotation.SwipeableItemAfterReactions;
...
public interface SwipeableItemViewHolder {
     ...
     *              - {@link com.brain.words.puzzle.game.swipeable.SwipeableItemConstants#STATE_FLAG_SWIPING}
     *              - {@link com.brain.words.puzzle.game.swipeable.SwipeableItemConstants#STATE_FLAG_IS_ACTIVE}
     *              - {@link com.brain.words.puzzle.game.swipeable.SwipeableItemConstants#STATE_FLAG_IS_UPDATED}
     */
     ...
     *               - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#RESULT_NONE}
     *               - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_LEFT}
     *               - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_UP}
     *               - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_RIGHT}
     *               - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_DOWN}
     *               - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#RESULT_CANCELED}
     */
     ...
     *                 - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_DEFAULT}
     *                 - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_MOVE_TO_ORIGIN}
     *                 - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_REMOVE_ITEM}
     *                 - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_MOVE_TO_SWIPED_DIRECTION}
     *                 - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_DO_NOTHING}
     */
     ...
     *               - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_LEFT}
     *               - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_RIGHT}
     */
     ...
     * @param amount Item swipe amount. Generally the range is [-1.0 .. 1.0] if the proportional amount mode is enabled, otherwise distance in pixels.
     *               In additionally, these special values can also be accepted;
     *               - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_TOP}
     *               - {@link com.brain.words.puzzle.game.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_BOTTOM}
     */
