package com.brain.words.puzzle.game.swipeable.action;
...
public abstract class SwipeResultAction {
    ...
    /**
     * This method is called immediately after returning from the {@link com.brain.words.puzzle.game.swipeable.SwipeableItemAdapter#onSwipeItem(RecyclerView.ViewHolder, int, int)} method.
