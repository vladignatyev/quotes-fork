...
class ProfileManager(models.Manager):
    ...
    def get_by_session(self, device_session):
        return self.select_for_update().get(device_sessions__pk__contains=device_session.pk)

    def get_by_token(self, device_session_token):
        return self.select_for_update().get(device_sessions__token__contains=device_session_token)
